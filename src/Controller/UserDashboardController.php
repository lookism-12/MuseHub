...
class UserDashboardController extends AbstractController
{
    ...
    public function list(Request $request): Response
    {
        ...
        if ($role) {
            // If filtering by ROLE_USER, we don't apply the filter because all users have ROLE_USER
            // implicitly or explicitly. Applying the filter would exclude users with empty roles array.
            if ($role !== 'ROLE_USER') {
